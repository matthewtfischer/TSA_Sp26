...
```{r}
p1 <- ggAcf(arma10, lag.max = 40) +
  ggtitle("ACF: ARMA(1,0)")

p2 <- ggAcf(arma01, lag.max = 40) +
  ggtitle("ACF: ARMA(0,1)")

p3 <- ggAcf(arma11, lag.max = 40) +
...
```{r}
p1 <- ggPacf(arma10, lag.max = 40) +
  ggtitle("PACF: ARMA(1,0)")

p2 <- ggPacf(arma01, lag.max = 40) +
  ggtitle("PACF: ARMA(0,1)")

p3 <- ggPacf(arma11, lag.max = 40) +
