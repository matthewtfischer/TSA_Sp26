...
hc_acf <- ggAcf(energy_ts[, 2], lag.max = 40, plot = TRUE) + 
  ggtitle(paste("Hydroelectric Consumption ACF")) +
  theme_minimal()

hc_pacf <- ggPacf(energy_ts[, 2], lag.max = 40, plot = TRUE) + 
  ggtitle(paste("Hydroelectric Consumption PACF")) +
  theme_minimal()
...
Total Renewable Energy Production has a definite positive trend while Hydroelectric Power Consumption does not appear to have a trend.
