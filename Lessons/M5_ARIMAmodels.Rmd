...
autoplot(decompose_residential_price)
...
compare_aic <- data.frame(Model_011$aic)
...
compare_aic <- data.frame(Model_211$aic)
...
compare_aic <- data.frame(Model_112$aic)
...
compare_aic <- data.frame(Model_212$aic)
